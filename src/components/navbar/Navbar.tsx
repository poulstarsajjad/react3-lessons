      ...
      <Container>
        <div className="grid grid-cols-3 items-center">
            ...
            <ul className="flex items-center justify-center gap-15">
                {
                    navs.map((nav)=>(
                        <li className="text-xl text-orange-400 text-shadow-sm text-shadow-orange-500 font-semibold cursor-pointer transition duration-300 hover:text-orange-300" key={nav.name}>
