      ...
      <Container>
        <div className="flex flex-col justify-center items-center gap-15 mx-20 mt-25 mb-15">
            <div className="w-2/3">
                ...
                <h2 className="text-xl font-bold">Going all-in with millennial design</h2>
                <p className="text-gray-500 my-3">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque aliquid illum ratione mollitia aut cumque quam assumenda laborum doloremque placeat, consequatur quidem culpa laboriosam odio obcaecati nihil harum aperiam voluptatibus.
                </p>
                <button className="text-sm border-b py-1 cursor-pointer transition duration-300 hover:text-orange-400">Read more</button>
            </div>
        </div>
      </Container>
      <StoreBenefits />
