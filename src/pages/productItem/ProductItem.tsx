...
function ProductItem() {
    ...
    const [productItem , setProductItem] = useState<Iproducts>({});
          ...
          <div>
            ...
            <div className="flex gap-20 items-center mt-10">
              <div className="flex items-center gap-5 border-2 border-orange-500 rounded-md">
                ...
                <span className="text-xl font-bold text-gray-600 text-center w-4">7</span>
                <button className="cursor-pointer transition duration-300 hover:scale-95">
              ...
              <div>
                <button className="bg-orange-400 text-orange-50 rounded py-3 px-10 cursor-pointer transition duration-300 hover:bg-orange-500">Add to cart</button>
              </div>
            </div>
          </div>
        </div>
